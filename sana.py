...
model = dict(
    ...
    pretrained_model_name_or_path='/mnt/hdfs/user/huangrunhui/huggingface_models/SANA1.5_1.6B_1024px_diffusers',
    # Required: override externally
    pretrained_vae_model_name_or_path='/mnt/hdfs/user/huangrunhui/huggingface_models/sdxl-vae-fp16-fix/',
...
# ---------------------------------------------------
data = dict(
    resolution=512,  # Resize all input images to this resolution
    train_batch_size=4,
...
training = dict(
    ...
    checkpointing_steps=50,  # Save a checkpoint every X steps
    checkpoints_total_limit=10,  # Maximum number of checkpoints to store
    resume_from_checkpoint=None,  # Checkpoint path to resume training, or "latest" for the most recent one
...
logging_config = dict(
    ...
    output_dir='/mnt/hdfs/user/huangrunhui/exps/illume_sana/illume_plus-sana-decoder-v2',
